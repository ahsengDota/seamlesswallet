                    ...
                    <div class="col-md-12">
                        ...
                        <table id="example1" class="display table table-stripped table-hover table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td width="5">1</td>
                                    <td><a href="http://localhost/testing_seamless/public/gamedetails">Sportsbook</a></td>
                                ...
                                <tr>
                                    <td width="5">2</td>
                                    <td><a href="" data-toggle="modal" data-target="#betlist">Slots</a></td>
                                    <td style="text-align:right;">0.00</td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                ...
                                <tr>
                                    <td width="5">3</td>
                                    <td><a href="" data-toggle="modal" data-target="#betlist">Live Casino</a></td>
                                    <td style="text-align:right;">0.00</td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
