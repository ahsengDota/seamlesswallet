...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Game Details - User Bet lists</li>
    </ol>
</section>
    ...
    <section class="col-lg-12 connectedSortable">
        ...
        <div class="box box-success">
            <div class="box-header">
                ...
                <h3 class="box-title">Game Details - User Bet lists</h3>
                        ...
                        <table id="example1" class="display table table-stripped table-hover table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:center;">Bet ID</th>
                                    <th style="text-align:center;">Bet Amount</th>
                                    <th style="text-align:center;">Win/Lose Amount</th>
                                    <th style="text-align:center;">Bet Status</th>
                                    <th style="text-align:center;">Result</th>
                                    <th style="text-align:center;">Bet Date</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    <td width="5">{{$key+1}}</td>
                                    <td style="text-align:center;">{{$bet['account']}}</td>
                                    <td style="text-align:center;">{{$bet['refid']}}</td>
                                    <td style="text-align:center;">{{$bet['betid']}}</td>
                                    <td style="text-align:right;">{{$bet['betAmount']}}</td>
                                    <td style="text-align:right;">{{$bet['backAmount']}}</td>
                                    <td style="text-align:center;">{{$bet['betStatus']}}</td>
                                    <td style="text-align:center;"></td>
                                    <td style="text-align:center;">{{$bet['created_at']}}</td>
                                </tr>
                                @endforeach
