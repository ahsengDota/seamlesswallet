                    ...
                    <div class="col-md-12">
                        ...
                        <table id="example1" class="display table table-stripped table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td width="5">{{$key+1}}</td>
                                    <td><a href="http://localhost/testing_seamless/public/gamedetails_userlist_betdetails">{{$bet['account']}}</a></td>
                                    <td style="text-align:right;">{{$bet['totalBetAmount']}}</td>
                                    <td style="text-align:right;">{{$bet['totalBackAmount']}}</td>
